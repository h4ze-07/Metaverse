  ...
  return (
    <section className={`${styles.sectionMarginTop} ${styles.innerWidth} px-[20px] relative z-10`}>
      ...
      <div className='flex flex-col-reverse lg:flex-row gap-[32px]'>
        ...
        variants={fadeIn('right', 'tween', 0.2, 0.5)} initial='hidden' whileInView='show' viewport={{once: false, amount: 0.25}}
        >
          ...
          variants={fadeIn('up', 'tween', 0.3, 0.6)} initial='hidden' whileInView='show' viewport={{once: false, amount: 0.25}}
          >Samantha</motion.h3>
          <motion.h4 className='text-[18px] text-white mb-[24px] z-10'
          variants={fadeIn('up', 'tween', 0.4, 0.5)} initial='hidden' whileInView='show' viewport={{once: false, amount: 0.25}}
          ...
          variants={fadeIn('up', 'tween', 0.6, 0.3)} initial='hidden' whileInView='show' viewport={{once: false, amount: 0.25}}
        ...
        variants={fadeIn('left', 'tween', 0.2, 0.5)} initial='hidden' whileInView='show' viewport={{once: false, amount: 0.25}}
        >
